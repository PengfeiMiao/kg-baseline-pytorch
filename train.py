...
if __name__ == '__main__':
    train_data = json.load(open(data_path + '/train_data_me.json', encoding='UTF-8'))
    dev_data = json.load(open(data_path + '/dev_data_me.json', encoding='UTF-8'))
    id2predicate, predicate2id = json.load(open(data_path + '/all_50_schemas_me.json', encoding='UTF-8'))
    id2predicate = {int(i): j for i, j in id2predicate.items()}
    id2char, char2id = json.load(open(data_path + '/all_chars_me.json', encoding='UTF-8'))
