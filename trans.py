...
with codecs.open(data_path + '/all_50_schemas_me.json', 'w', encoding='utf-8') as f:
...
with codecs.open(data_path + '/train_data_me.json', 'w', encoding='utf-8') as f:
...
with codecs.open(data_path + '/dev_data_me.json', 'w', encoding='utf-8') as f:
    json.dump(dev_data, f, indent=4, ensure_ascii=False)

with codecs.open(data_path + '/all_chars_me.json', 'w', encoding='utf-8') as f:
